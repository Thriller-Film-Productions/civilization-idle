function initButtons() {
  buttons.startGame = new button(width / 2 - 100, height / 2 - 50, 200, 100, color(0, 150, 0), startGame, true);
  buttons.build = new button(width / 1.1 - 125, height / 1.2, 128, 128, color(0, 0, 0), () => {}, true, assets.build, width / 1.1, height / 1.2, 500);
}
